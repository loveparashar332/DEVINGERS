      ...
      <ChatBot
        ...
        steps={[
          ...
          },
          {
            id: "CommonOptions",
            options: [
                    { value: 'Emergency', label: 'Emergency', trigger: "LinkRouting" },
                    { value: "Workshops", label: 'Workshops Around me', trigger: 'LinkRouting' }, 
                    { value: 3, label: 'Find me more to do', trigger: "MoreOptions" },
            ],
          },
          {
            id: "MoreOptions",
